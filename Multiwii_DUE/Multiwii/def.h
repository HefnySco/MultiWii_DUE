...
// M.Hefny
#if (defined(MEGA) || defined (ARDUINO_DUE))&& defined(MEGA_HW_PWM_SERVOS)
  #define TRI_SERVO  4
#else
  #define TRI_SERVO  6
#endif
...
/**************************  Arduino DUE  ***********************************/
 ...
 // MHefny: DUE UPDATED 
  #define LEDPIN_PINMODE             pinMode (13, OUTPUT);pinMode (30, OUTPUT);
  #define LEDPIN_TOGGLE              digitalWrite (13,~digitalRead(13)); digitalWrite (30,~digitalRead(30)); /* PINB  |= (1<<7); PINC  |= (1<<7); */
  #define LEDPIN_ON                  digitalWrite (13,1); digitalWrite (30,1);/* PORTB |= (1<<7); PORTC |= (1<<7); */
  #define LEDPIN_OFF                 digitalWrite (13,0); digitalWrite (30,0);/* PORTB &= ~(1<<7);PORTC &= ~(1<<7); */
  #define BUZZERPIN_PINMODE          pinMode (32, OUTPUT);
  #if defined PILOTLAMP
    #define    PL_PIN_ON    PORTC |= 1<<5;
    #define    PL_PIN_OFF   PORTC &= ~(1<<5);
  #else
	// MHefny: DUE UPDATED  PORTC --> PORTD 10  = Arduino(32)
    #define BUZZERPIN_ON               digitalWrite (32, 1); // PIOD10,  PORTC |= 1<<5;
    #define BUZZERPIN_OFF              digitalWrite (32, 0); // PORTC &= ~(1<<5);
  #endif 
